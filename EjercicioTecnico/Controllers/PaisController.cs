...
namespace EjercicioTecnico.Controllers
{
    public class PaisController : Controller
    {
        ...
        public PaisController(EntityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Activo")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Activo")] Pais pais)
        {
            if (id != pais.Id)
            {
                return NotFound();
