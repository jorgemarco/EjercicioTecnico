...
namespace EjercicioTecnico.Controllers
{
    public class TipoController : Controller
    {
        ...
        public TipoController(EntityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Activo")] Tipo tipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Activo")] Tipo tipo)
        {
            if (id != tipo.Id)
            {
                return NotFound();
